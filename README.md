[![Deploy on Railway](https://railway.app/button.svg)](https://railway.app/new/template?template=https%3A%2F%2Fgithub.com%2brblacky%2lavamusic&envs=TOKEN%2CGUILD_ID&optionalEnvs=GUILD_ID&TOKENDesc=Your+Bot%27s+Token&TEST_GUILD_IDDesc=Your+development+server%27s+guild+ID%2C+only+add+this+if+your+bot+is+in+development&referralCode=7OsmmG)
