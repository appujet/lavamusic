[![Deploy on Railway](https://railway.app/button.svg)](https://railway.app/new/template?template=https%3A%2F%2Fgithub.com%2Fbrblacky%2Flavamusic&envs=COlOR%2CHOST%2CID%2CLOGS%2CMONGO_URI%2COWNERID%2CPASS%2CPORT%2CPREFIX%2CSECURE%2CSPOTIFYID%2CSPOTIFYSECRET%2CTOKEN&optionalEnvs=COlOR%2COWNERID&COlORDesc=embed+colour+code+hex&HOSTDesc=lavalink+server+host&IDDesc=lavalink+server+id&LOGSDesc=Channel+I%27d&MONGO_URIDesc=Your+Mongo+url&OWNERIDDesc=your+discord+id&PASSDesc=lavalink+server+password&PORTDesc=lavalink+server+port&PREFIXDesc=your+bot+prefix&SECUREDesc=lavalink+server+secure&SPOTIFYIDDesc=Spotify+client+id&SPOTIFYSECRETDesc=Spotify+client+secret&TOKENDesc=Your+bot%27s+bot+token.&COlORDefault=%23303236&HOSTDefault=disbotlistlavalink.ml&IDDefault=main&PASSDefault=LAVA&PORTDefault=443&PREFIXDefault=%21&SECUREDefault=true&referralCode=kcnA8M)[![Deploy](https://www.herokucdn.com/deploy/button.svg)](https://heroku.com/deploy?template=https://github.com/brblacky/lavamusic)
