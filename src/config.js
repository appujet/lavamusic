...
export const config = {
    ...
    color: {
    default: process.env.DEFAULT_COLOR || 0x00ff00,
    error: process.env.ERROR_COLOR || 0xff0000,
    success: process.env.SUCCESS_COLOR || 0x00ff00,
    info: process.env.INFO_COLOR || 0x00ffff,
    warn: process.env.WARN_COLOR || 0xffff00,
     },
