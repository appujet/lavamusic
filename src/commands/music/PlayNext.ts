          ...
          return await ctx.editMessage({
            ...
            embeds: [
              embed
                ...
                .setDescription(ctx.locale("cmd.playnext.errors.queue_too_long", { maxQueueSize: client.config.maxQueueSize })),
            ],
          });
        ...
        await ctx.editMessage({
          ...
          embeds: [
            embed
              ...
              .setDescription(ctx.locale("cmd.playnext.added_to_play_next", { title: res.data.info.title, uri: res.data.info.uri })),
          ],
        });
        break;
      }
        ...
        if (res.data.tracks.length > client.config.maxPlaylistSize)
          return await ctx.editMessage({
            ...
            embeds: [
              embed
                .setColor(this.client.color.red)
                .setDescription(ctx.locale("cmd.playnext.errors.playlist_too_long", { maxPlaylistSize: client.config.maxPlaylistSize })),
            ],
          });
      ...
      case LoadType.SEARCH: {
        ...
        await ctx.editMessage({
          ...
          embeds: [
            embed
              .setColor(this.client.color.main)
              .setDescription(ctx.locale("cmd.playnext.added_to_play_next", { title: res.data[0].info.title, uri: res.data[0].info.uri })),
          ],
        });
        break;
      }
