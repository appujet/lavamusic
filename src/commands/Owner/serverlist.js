...
module.exports = {
    ...
    execute: async (message, args, client, prefix) => {
        ...
        const but1 = new ButtonBuilder().setCustomId("queue_cmd_but_1").setEmoji("⏭️").setStyle("Primary");

        const but2 = new ButtonBuilder().setCustomId("queue_cmd_but_2").setEmoji("⏮️").setStyle("Primary");

        const but3 = new ButtonBuilder().setCustomId("queue_cmd_but_3").setEmoji("⏹️").setStyle("Danger");
