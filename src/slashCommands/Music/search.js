...
module.exports = {
  name: i18n.__("cmd.search.name"),
  description: i18n.__("cmd.search.des"),
  options: [
    {
      name: i18n.__("cmd.search.slash.name"),
      description: i18n.__("cmd.search.slash.des"),
      required: true,
      type: "STRING",
    },
  ],
    ...
    switch (s.loadType) {
      ...
      case "SEARCH_RESULT":
        ...
        const searched = new MessageEmbed()
          .setTitle(i18n.__("cmd.search.title"))
          .setColor(client.embedColor)
        ...
        const collector = interaction.channel.createMessageComponentCollector({
          filter: (f) =>
            f.userId === interaction.authorId ? true : false && f.deferUpdate(),
          max: 1,
          time: 60000,
          idle: 60000 / 2,
        });
