...
module.exports = {
    ...
    .setURL("https://discord.gg/gfcv94hDhv")
          ...
          const mainPage = new EmbedBuilder()
            ...
            .setColor('#303236')
             .addFields([{ name: 'invite lavamusic', `[Here](https://discord.com/api/oauth2/authorize?client_id=${client.user.id}&permissions=36768832&scope=applications.commands%20bot)`}])
