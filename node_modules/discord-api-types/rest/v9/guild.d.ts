...
import type { AddUndefinedToPossiblyUndefinedPropertiesOfInterface, Nullable, StrictPartial, StrictRequired } from '../../utils/internals';
...
export declare type APIGuildCreatePartialChannel = StrictPartial<Pick<APIChannel, 'type' | 'topic' | 'nsfw' | 'bitrate' | 'user_limit' | 'rate_limit_per_user'>> & AddUndefinedToPossiblyUndefinedPropertiesOfInterface<{
    name: string;
    id?: number | string;
